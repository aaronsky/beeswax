...
interface PinnedMessage extends PinnedItemBase {
    type: 'message';
    channel: string;
    message: Message;
}
interface PinnedFile extends PinnedItemBase {
    type: 'message';
    channel: string;
    message: Message;
}
interface PinnedFileComment extends PinnedItemBase {
    type: 'message';
    channel: string;
    message: Message;
}
...
export namespace WebApi {
    ...
    export interface PinsListResponse extends Response {
        items: (PinnedMessage | PinnedFile | PinnedFileComment)[];
    }
